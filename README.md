...
正式架构地基见 `docs/v1正式版本/技术设计/概要设计/`（下称「v1 概要设计」，已按模块拆为 00–10 共 11 篇，入口 `00-架构总纲与裁决索引.md`，含「原 § → 新文档」映射与 D1–D24 裁决表）。任何冲突一律以该拆分集为准。
...
|------|------|
| `README.md` | 仓库结构与边界 |
| `docs/v1正式版本/技术设计/概要设计/`（00–10 共 11 篇，入口 `00-架构总纲与裁决索引.md`） | **v1 架构地基，唯一裁决口径**（三端边界、Manager 多租户隔离、认证、Agent Gateway、D1–D24 裁决；总纲含「原 § → 新文档」映射与导航） |
