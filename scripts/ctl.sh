  ...
  case "${service}" in
    ...
    manager)
      ...
      nohup setsid env \
        ...
        -u HINDSIGHT_CP_ACCESS_KEY -u LIGHTRAG_AUTH_ACCOUNTS -u LIGHTRAG_ADMIN_USERNAME -u LIGHTRAG_ADMIN_PASSWORD -u LIGHTRAG_TOKEN_SECRET -u LIGHTRAG_JWT_ALGORITHM \
    ...
    operation)
      ...
      nohup setsid env \
        ...
        -u NEWAPI_ADMIN_USERNAME -u NEWAPI_ADMIN_PASSWORD -u HINDSIGHT_CP_ACCESS_KEY -u LIGHTRAG_AUTH_ACCOUNTS -u LIGHTRAG_ADMIN_USERNAME -u LIGHTRAG_ADMIN_PASSWORD -u LIGHTRAG_TOKEN_SECRET -u LIGHTRAG_JWT_ALGORITHM \
        APP_TIER=operation \
        AITEAM_ENV="${AITEAM_ENV:-dev}" \
        ADMIN_DB_URL="${ADMIN_DB_URL}" \
        APP_RW_PASSWORD="${APP_RW_PASSWORD}" \
