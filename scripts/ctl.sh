...
start_service_local() {
  ...
  case "${service}" in
    ...
    manager)
      ...
      nohup setsid env \
        -u NEWAPI_URL -u NEWAPI_ADMIN_BASE_URL -u NEWAPI_PUBLIC_BASE_URL -u MODEL_PRICING_URL -u NEWAPI_ADMIN_TOKEN -u NEWAPI_ADMIN_USER_ID -u NEWAPI_DB_PASSWORD -u NEWAPI_REDIS_PASSWORD -u NEWAPI_SESSION_SECRET -u NEWAPI_CRYPTO_SECRET \
        ...
        HINDSIGHT_CONSOLE_URL="${HINDSIGHT_CONSOLE_URL:-}" \
        ...
        LIGHTRAG_CONSOLE_URL="${LIGHTRAG_CONSOLE_URL:-}" \
    ...
    operation)
      ...
      nohup setsid env \
        ...
        -u HINDSIGHT_URL -u HINDSIGHT_CONSOLE_URL -u HINDSIGHT_SERVICE_TOKEN -u HINDSIGHT_RECALL_PATH -u HINDSIGHT_RETAIN_PATH -u HINDSIGHT_DELETE_PATH \
        -u LIGHTRAG_URL -u LIGHTRAG_CONSOLE_URL -u LIGHTRAG_API_KEY -u LIGHTRAG_WORKSPACE \
        APP_TIER=operation \
        AITEAM_ENV="${AITEAM_ENV:-dev}" \
        ADMIN_DB_URL="${ADMIN_DB_URL}" \
        APP_RW_PASSWORD="${APP_RW_PASSWORD}" \
    ...
    agent)
      ...
      nohup setsid env \
        ...
        -u NEWAPI_URL -u NEWAPI_ADMIN_BASE_URL -u NEWAPI_PUBLIC_BASE_URL -u MODEL_PRICING_URL -u NEWAPI_ADMIN_TOKEN -u NEWAPI_ADMIN_USER_ID -u NEWAPI_DB_PASSWORD -u NEWAPI_REDIS_PASSWORD -u NEWAPI_SESSION_SECRET -u NEWAPI_CRYPTO_SECRET \
        -u OPERATION_SYSTEM_PASSWORD -u OPERATION_SIGNING_PRIVATE_KEY -u OPERATION_PROVIDER_CREDENTIAL_KEY \
        -u LIGHTRAG_URL -u LIGHTRAG_CONSOLE_URL -u LIGHTRAG_API_KEY -u LIGHTRAG_WORKSPACE -u LIGHTRAG_TIMEOUT_MS -u LIGHTRAG_PIPELINE_TIMEOUT_MS -u LIGHTRAG_POLL_INTERVAL_MS -u LIGHTRAG_QUERY_MODE \
        ...
        -u AITEAM_HINDSIGHT_URL -u HINDSIGHT_URL -u HINDSIGHT_CONSOLE_URL -u HINDSIGHT_SERVICE_TOKEN -u HINDSIGHT_RECALL_PATH -u HINDSIGHT_RETAIN_PATH -u HINDSIGHT_DELETE_PATH -u HINDSIGHT_API_TOKEN -u HINDSIGHT_API_KEY -u HINDSIGHT_API_KEY_REF \
