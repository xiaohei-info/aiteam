...
STYLE_CSS = (pathlib.Path(__file__).parent.parent.parent / "static" / "style.css").read_text(encoding="utf-8")
UI_JS = (pathlib.Path(__file__).parent.parent.parent / "static" / "ui.js").read_text(encoding="utf-8")
