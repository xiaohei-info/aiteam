...
PANELS_JS = (Path(__file__).resolve().parent.parent.parent / "static" / "panels.js").read_text("utf-8")
I18N_JS = (Path(__file__).resolve().parent.parent.parent / "static" / "i18n.js").read_text("utf-8")
STYLE_CSS = (Path(__file__).resolve().parent.parent.parent / "static" / "style.css").read_text("utf-8")
...
def test_toggle_path_registered():
    ...
    routes_source = (Path(__file__).resolve().parent.parent.parent / "api" / "routes.py").read_text("utf-8")
