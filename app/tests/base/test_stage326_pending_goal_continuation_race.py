...
def _read_streaming():
    return Path(__file__).parent.parents[2].joinpath("api", "streaming.py").read_text(encoding="utf-8")


def _read_routes():
    return Path(__file__).parent.parents[2].joinpath("api", "routes.py").read_text(encoding="utf-8")
