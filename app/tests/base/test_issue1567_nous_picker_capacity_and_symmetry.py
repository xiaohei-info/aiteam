...
class TestFrontendExtrasContract:
    ...
    def test_ui_js_hydrates_dynamic_labels_from_extra_models(self):
        ...
        src = (Path(__file__).resolve().parent.parent.parent / "static" / "ui.js").read_text(encoding="utf-8")
    ...
    def test_commands_js_loads_slash_args_from_extra_models(self):
        from pathlib import Path
        src = (Path(__file__).resolve().parent.parent.parent / "static" / "commands.js").read_text(encoding="utf-8")
    ...
    def test_panels_js_uses_models_total_for_count(self):
        from pathlib import Path
        src = (Path(__file__).resolve().parent.parent.parent / "static" / "panels.js").read_text(encoding="utf-8")
