...
def test_frontend_renders_apperror_details_in_collapsible_block():
    messages_js = (streaming.Path(__file__).resolve().parent.parent.parent / 'static' / 'messages.js').read_text()
    ui_js = (streaming.Path(__file__).resolve().parent.parent.parent / 'static' / 'ui.js').read_text()
    style_css = (streaming.Path(__file__).resolve().parent.parent.parent / 'static' / 'style.css').read_text()
