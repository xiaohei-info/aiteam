...
class TestApprovalCardTimerLogic:
    ...
    def _get_js(self):
        return pathlib.Path(__file__).parent.parent.parent / 'static' / 'messages.js'
...
class TestClarifyCardTimerLogic:
    ...
    def _get_html(self):
        return pathlib.Path(__file__).parent.parent.parent / 'static' / 'index.html'

    def _get_css(self):
        return pathlib.Path(__file__).parent.parent.parent / 'static' / 'style.css'
