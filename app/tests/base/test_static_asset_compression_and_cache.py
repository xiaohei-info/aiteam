...
def _patch_static_root(monkeypatch, static_root):
    ...
    # _serve_static derives static_root from `Path(__file__).parent.parent.parent / "static"`,
...
def isolated_static(tmp_path, monkeypatch):
    ...
    # _serve_static derives static_root from Path(__file__).parent.parent.parent.
