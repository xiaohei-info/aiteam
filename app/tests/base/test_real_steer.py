...
class TestRouting:
    ...
    def test_route_registered(self):
        src = (Path(__file__).parent.parent.parent / "api" / "routes.py").read_text(encoding="utf-8")
...
class TestFrontendWiring:
    ...
    @classmethod
    def setup_class(cls):
        cls.cmds = (Path(__file__).parent.parent.parent / "static" / "commands.js").read_text(encoding="utf-8")
        cls.msgs = (Path(__file__).parent.parent.parent / "static" / "messages.js").read_text(encoding="utf-8")
        cls.i18n = (Path(__file__).parent.parent.parent / "static" / "i18n.js").read_text(encoding="utf-8")
...
class TestLeftoverDelivery:
    ...
    def test_leftover_drain_call_in_streaming(self):
        ...
        src = (Path(__file__).parent.parent.parent / "api" / "streaming.py").read_text(encoding="utf-8")
