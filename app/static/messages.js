...
function attachLiveStream(activeSid, streamId, uploaded=[], options={}){
  ...
  function _dispatchAiTeamTimelineEvent(event){
    if(!(window.aiteam&&window.aiteam.timeline&&typeof window.aiteam.timeline.handleEvent==='function')) return false;
    window.aiteam.timeline.handleEvent(event);
    return true;
  }
  ...
  function _wireSSE(source){
    ...
    source.addEventListener('timeline',e=>{
      if(_dispatchAiTeamTimelineEvent(e)) return;
    });
