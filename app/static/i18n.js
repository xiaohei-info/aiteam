...
const LOCALES = {
  en: {
    ...
    offline_network_detail: 'AIFred is unreachable from this browser right now.',
    offline_autorefresh: 'I will refresh this page automatically when AIFred is reachable again.',
  ...
  it: {
    ...
    offline_network_detail: 'AIFred non è raggiungibile da questo browser al momento.',
    offline_autorefresh: 'Aggiornerò automaticamente la pagina quando AIFred sarà di nuovo raggiungibile.',
  ...
  ja: {
    ...
    offline_network_detail: '現在、このブラウザからAIFredに到達できません。',
    offline_autorefresh: 'AIFredに再接続できたら、このページを自動的に更新します。',
  ...
  ru: {
    ...
    offline_network_detail: 'AIFred сейчас недоступен из этого браузера.',
    offline_autorefresh: 'Я автоматически обновлю страницу, когда AIFred снова станет доступен.',
  ...
  es: {
    ...
    offline_network_detail: 'AIFred no está disponible desde este navegador ahora mismo.',
    offline_autorefresh: 'Actualizaré esta página automáticamente cuando AIFred vuelva a estar disponible.',
  ...
  de: {
    ...
    offline_network_detail: 'AIFred ist von diesem Browser aus gerade nicht erreichbar.',
    offline_autorefresh: 'Ich aktualisiere diese Seite automatisch, sobald AIFred wieder erreichbar ist.',
  ...
  zh: {
    ...
    offline_network_detail: '此浏览器当前无法连接到 AIFred。',
    offline_autorefresh: '当 AIFred 可访问时，我会自动刷新此页面。',
  ...
  pt: {
    ...
    offline_network_detail: 'O AIFred está inacessível neste navegador agora.',
    offline_autorefresh: 'Vou atualizar esta página automaticamente quando o AIFred voltar a responder.',
  ...
  ko: {
    ...
    offline_network_detail: '현재 이 브라우저에서 AIFred에 연결할 수 없습니다.',
    offline_autorefresh: 'AIFred에 다시 연결되면 이 페이지를 자동으로 새로고침합니다.',
  ...
  fr: {
    ...
    offline_network_detail: 'AIFred est actuellement inaccessible depuis ce navigateur.',
  ...
  tr: {
    ...
    offline_network_detail: 'AIFred\'e şu anda bu tarayıcıdan ulaşılamıyor.',
    offline_autorefresh: 'AIFred\'e tekrar ulaşılabilir olduğunda bu sayfayı otomatik olarak yenileyeceğim.',
