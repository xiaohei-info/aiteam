            ...
            "content": _json_content(
                _obj(
                    ["title", "member_employee_ids"],
                    {
                        ...
                        "collaboration_mode": {"type": "string", "enum": ["free", "orchestrated"],
                                               "description": "自由讨论(free，默认) | 规则编排(orchestrated)"},
                        "orchestration_brief": {"type": "string",
                                                "description": "规则编排模式下的 planner 预设编排指令；orchestrated 必填"},
                    },
                ),
