...
def build_mainline_router(service: MainlineService) -> APIRouter:
    ...
    @router.post("/conversations", summary="建会话", operation_id="agent_create_conversation")
    ...
    @router.get("/conversations", summary="列会话", operation_id="agent_list_conversations")
    async def list_conversations() -> ListEnvelope[Conversation]:
        return ListEnvelope[Conversation](data=service.list_conversations())

    @router.get("/conversations/{conversation_id}", summary="取会话",
                operation_id="agent_get_conversation")
    ...
    @router.put("/conversations/{conversation_id}/state", summary="改会话主状态",
                operation_id="agent_set_conversation_state")
    ...
    @router.post("/conversations/{conversation_id}/messages", summary="发消息",
                 operation_id="agent_add_message")
    ...
    @router.get("/conversations/{conversation_id}/messages", summary="列消息",
    ...
    @router.get("/runs/{run_id}", summary="取 run", operation_id="agent_get_run")
    async def get_run(run_id: str) -> Envelope[Run]:
        return Envelope[Run](data=service.get_run(run_id))

    @router.post("/runs/{run_id}/cancel", summary="取消 run", operation_id="agent_cancel_run")
    ...
    @router.post("/conversations/{conversation_id}/tasks", summary="建 task",
                 operation_id="agent_create_task")
    ...
    @router.get("/conversations/{conversation_id}/tasks", summary="列 task",
                operation_id="agent_list_tasks")
    ...
    @router.get("/conversations/{conversation_id}/timeline", summary="时间线增量拉取",
                operation_id="agent_read_timeline")
    ...
    @router.get("/conversations/{conversation_id}/timeline/stream", summary="时间线 SSE 流",
                operation_id="agent_stream_timeline")
