 ...
 * 已招募专家实例（列出 + 编辑配置：模型/运行时/能力/记忆策略，PUT 全量替换）、
 * 已应用方案实例（只读详情，方案定义在 Operator 端完成）。owner/enterprise_admin 可写，其余只读（后端鉴权兜底）。
 */
...
/** 方案实例卡片：只读展示（PRD B06：方案实例定义在 Operator 端，Manager 不可编辑）。 */
